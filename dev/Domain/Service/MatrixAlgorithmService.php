...
class MatrixAlgorithmService
{
     ...
     * @return array
     */
    public function multiply($stringArray, $matrixArray)
    {
        $stringArrayRows = count($stringArray);
        $stringArrayCols = count($stringArray[0]);

        $matrixArrayRows = count($matrixArray);
...
//            return $result;
     ...
     * @return array
     */
    public function convertStringToBinary($string)
    {
        $binariesArray = [];
        for ($i = 0; $i < strlen($string); $i++) {
            ...
            if (strlen($binaryRepresentation) == 7)
            {
                $binaryRepresentation = '0'.$binaryRepresentation;
            }

            for ($j=0; $j < strlen($binaryRepresentation); $j++){

                array_push($arr, intval($binaryRepresentation[$j]));
            }
            $binariesArray[] = $arr;
        }
